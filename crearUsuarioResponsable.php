...
if(ejecutar($sql)){
        ...
        $message = "Bienvenido la aplicacion geolocalizador, le informamos que su cuenta esta INACTIVA, para activar su cuenta usted varificarla, para hacerlo puede seguir la siguiente direcci�n: "."https://raesaldro.000webhostapp.com/WebServicesGeolocalizador/verificarCuenta.php?correo=".$correo_electronico;
        $header = "From:" . $from;
