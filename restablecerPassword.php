            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <input type="hidden" id="correo" value="'$correo'" class="form-control contrasenia" required>
                        <input type="hidden" id="id" value="'$id'" class="form-control contrasenia" required>
